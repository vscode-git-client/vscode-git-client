...
- **Commit Details working-tree compare context menu** — file rows shown after comparing a folder with a revision now expose the `Open Diffs` context menu and support opening multiple selected diffs.
