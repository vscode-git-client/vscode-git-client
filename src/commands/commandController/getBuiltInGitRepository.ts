...
import { GitScmExtensionExports, GitScmRepository } from '../types';

export async function getBuiltInGitRepository(this: CommandController): Promise<GitScmRepository | undefined> {
