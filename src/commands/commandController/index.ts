...
export class CommandController {
  ...
  public async openBranchCommits(branchName: string): Promise<void> {
    await this.openRefCommits(`branch:${branchName}`, `Branch: ${branchName}`, branchName);
  }

  public async openRefCommits(id: string, title: string, ref: string): Promise<void> {
  ...
  public async openDirectoryTimeline(repoRelativePath: string): Promise<void> {
  ...
  public async sshPull(targetHost: string | 'prompt'): Promise<void> {
  ...
  public async openDiffWorkflow(): Promise<void> {
  ...
  public pickConflictPathArg(arg: unknown): string | undefined {
  ...
  public async pickConflictPath(title: string): Promise<string | undefined> {
    const conflicts =
  ...
  public normalizeBranchActionHubArg(arg: unknown): string | undefined {
  ...
  public resolveBranchNameForActionHub(rawBranchName: string): string | undefined {
  ...
  public async pickWorktreeRevision(title: string): Promise<RevisionSelection | undefined> {
  ...
  public async pickWorktreeTargetPath(title: string, refName: string): Promise<string | undefined> {
  ...
  public async pickStashRef(title: string): Promise<string | undefined> {
  ...
  public async pickCommitSha(title: string): Promise<string | undefined> {
  ...
  public async pickFileFromWorkspace(title: string): Promise<string | undefined> {
  ...
  public async getBuiltInGitRepository(): Promise<GitScmRepository | undefined> {
  ...
  public async openSelectedFileDiffs(arg: unknown, selectedArg: unknown): Promise<boolean> {
  ...
  public async openCommitActionContextDiffs(context: CommitActionContext): Promise<void> {
  ...
  public async pickPatchOutputTarget(title: string): Promise<'clipboard' | 'file' | undefined> {
    const picked = await vscode.window.showQuickPick(
      [
        {
  ...
  public async pickPatchSource(): Promise<{ kind: 'clipboard' | 'file' } | undefined> {
    const picked = await vscode.window.showQuickPick(
      [
        {
  ...
  public async readPatchFromFile(): Promise<string | undefined> {
    const picked = await vscode.window.showOpenDialog({
  ...
  public async applyPatchToWorkingTree(patch: string, context: { source: string }): Promise<void> {
  ...
  public async resolveSelectedCommitFiles(
    arg: unknown,
    selectedArg: unknown
  ...
  public toSelectedChangeTarget(context: CommitActionContext): SelectedChangeTarget {
    if (context.kind === 'commit') {
      return {
        kind: 'commit',
        sha: context.sha,
  ...
  public toSelectedItems(arg: unknown, selectedArg: unknown): SelectableChangeTreeItem[] {
  ...
  public extractSelectableItem(value: unknown): SelectableChangeTreeItem | undefined {
  ...
  public classifyCherryPickIssue(error: unknown): { kind: CherryPickIssueKind; message?: string } {
  ...
  public classifyMergeIssue(error: unknown): { kind: MergeIssueKind; message?: string } {
    const message = this.getErrorSummary(error);
    const normalized = message.toLowerCase();
  ...
  public classifyRebaseIssue(error: unknown): { kind: RebaseIssueKind; message?: string } {
    const message = this.getErrorSummary(error);
    const normalized = message.toLowerCase();
  ...
  public getErrorSummary(error: unknown): string {
  ...
  public async startMergeOperation(run: () => Promise<void>): Promise<void> {
    try {
      await run();
    } catch (error) {
  ...
  public async startRebaseOperation(run: () => Promise<void>): Promise<void> {
    try {
      await run();
    } catch (error) {
  ...
  public async handleRebaseConflict(): Promise<void> {
    void vscode.window.showWarningMessage(
  ...
  public async handleOperationConflict(
  ...
  public async showRebaseProgressFeedback(): Promise<void> {
  ...
  public async openOperationConflictEditors(
    operation: 'cherry-pick' | 'merge' | 'rebase'
  ): Promise<void> {
    const conflicts =
      this.state.conflicts.length > 0 ? this.state.conflicts : await this.git.getMergeConflicts();
  ...
  public asBranchItem(value: unknown): BranchTreeItem | undefined {
    return value instanceof BranchTreeItem ? value : undefined;
  }

  public asBranchRemoteItem(value: unknown): BranchRemoteNode | undefined {
    return value instanceof BranchRemoteNode ? value : undefined;
  }

  public asTagItem(value: unknown): TagTreeItem | undefined {
    return value instanceof TagTreeItem ? value : undefined;
  }

  public asStashItem(value: unknown): StashTreeItem | undefined {
    return value instanceof StashTreeItem ? value : undefined;
  }

  public asGraphItem(value: unknown): GraphCommitTreeItem | undefined {
    return value instanceof GraphCommitTreeItem ? value : undefined;
  }

  public asGraphFileItem(value: unknown): GraphCommitFileTreeItem | undefined {
    return value instanceof GraphCommitFileTreeItem ? value : undefined;
  }

  public asCommitViewFileItem(value: unknown): CommitFileTreeItem | undefined {
    return value instanceof CommitFileTreeItem ? value : undefined;
  }

  public asRevisionViewFileItem(value: unknown): RevisionFileTreeItem | undefined {
    return value instanceof RevisionFileTreeItem ? value : undefined;
  }

  public legacyCommandId(command: string): string | undefined {
    return command.startsWith(GIT_COMMAND_PREFIX)
      ? `intelliGit.${command.slice(GIT_COMMAND_PREFIX.length)}`
      : undefined;
  }

  public asCommitRangeFileItem(
    value: unknown
  ):
  ...
  public asWorkingTreeCompareFileItem(
    value: unknown
  ...
  public asFileResourceUri(value: unknown): vscode.Uri | undefined {
  ...
  public toExplorerResourceUris(arg: unknown, selectedArg: unknown): vscode.Uri[] {
  ...
  public toBranchName(value: unknown): string | undefined {
  ...
  public toRepoFilePath(value: unknown): string | undefined {
    if (typeof value === 'string') {
  ...
  public toCommitSha(value: unknown): string | undefined {
    if (typeof value === 'string') {
      const trimmed = value.trim();
      return trimmed || undefined;
    }
  ...
  public toCommitSubject(value: unknown): string | undefined {
  ...
  public resolveCommitSubject(sha: string, argValue: unknown, selectedArgValue: unknown): string {
  ...
  public toGraphCommitShas(arg: unknown, selectedArg: unknown): string[] {
  ...
  public toTagRef(value: unknown): string | undefined {
    return this.asTagItem(value)?.tag.name;
  }

  public toTagRevision(value: unknown): string | undefined {
    const tag = this.asTagItem(value)?.tag;
  ...
  public async orderShasForCherryPick(shas: string[]): Promise<string[]> {
    if (shas.length <= 1) {
      return shas;
    }
    try {
  ...
  public async handleCherryPick(arg?: unknown, selected?: unknown): Promise<void> {
  ...
  public async handleOpenFileDiff(arg?: unknown, selected?: unknown): Promise<void> {
  ...
  public async handleCherryPickSelectedChanges(arg?: unknown, selected?: unknown): Promise<void> {
  ...
  public async handleCreatePatchSelectedChanges(arg?: unknown, selected?: unknown): Promise<void> {
    const target = await this.resolveSelectedCommitFiles(arg, selected);
    if (!target) {
      void vscode.window.showInformationMessage('Select one or more files from a commit first.');
      return;
  ...
  public async handleRevertSelectedChanges(arg?: unknown, selected?: unknown): Promise<void> {
    const target = await this.resolveSelectedCommitFiles(arg, selected);
    if (!target) {
      void vscode.window.showInformationMessage('Select one or more files from a commit first.');
      return;
  ...
  public async handleApplyPatch(): Promise<void> {
  ...
  public async handleEditCommitMessage(arg?: unknown): Promise<void> {
  ...
  public async handlePushAllUpToHere(arg?: unknown): Promise<void> {
  ...
  public async handleOperationAbort(): Promise<void> {
  ...
  public async handleOperationContinue(): Promise<void> {
    const state = await this.git.getOperationState();
    if (state.kind === 'none') {
      void vscode.window.showInformationMessage('No merge/rebase/cherry-pick/revert in progress.');
      return;
  ...
  public async handleShelveResource(arg?: unknown): Promise<void> {
  ...
  public async handleCommitTemplate(): Promise<void> {
  ...
  public async handleScmAmendFromInput(): Promise<void> {
    const repository = await this.getBuiltInGitRepository();
    if (!repository) {
      void vscode.window.showWarningMessage('Git repository context not available.');
      return;
  ...
  public async handleDirectoryTimelineOpen(arg?: unknown): Promise<void> {
  ...
  public async handleCompareWithRevision(arg?: unknown, selected?: unknown): Promise<void> {
  ...
  public async handleResetCurrentToCommit(arg?: unknown): Promise<void> {
    const target =
  ...
  public async handleStashCreate(): Promise<void> {
    const message = (
      await vscode.window.showInputBox({
        title: 'Create stash',
  ...
  public async handleBranchSearch(): Promise<void> {
  ...
  public async handleGraphFilter(): Promise<void> {
  ...
  public async handleSetRemoteUrl(arg?: unknown): Promise<void> {
  ...
  public async handleStashApplyPop(arg?: unknown, pop?: boolean): Promise<void> {
  ...
  public async handleSubmoduleDeinit(arg?: unknown): Promise<void> {
  ...
  public async handleSubmoduleStagePointerChange(arg?: unknown): Promise<void> {
    const item = arg instanceof SubmoduleTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleSubmoduleDiffPointer(arg?: unknown): Promise<void> {
    const item = arg instanceof SubmoduleTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleSubmodulePullTrackedBranch(arg?: unknown): Promise<void> {
    const item = arg instanceof SubmoduleTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleSubmoduleCheckoutRecorded(arg?: unknown): Promise<void> {
    const item = arg instanceof SubmoduleTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleSubmoduleOpenTerminal(arg?: unknown): Promise<void> {
    const item = arg instanceof SubmoduleTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleSubmoduleOpenInNewWindow(arg?: unknown): Promise<void> {
    const item = arg instanceof SubmoduleTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleSubmoduleOpen(arg?: unknown): Promise<void> {
    const item = arg instanceof SubmoduleTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleSubmoduleSyncAll(): Promise<void> {
  ...
  public async handleSubmoduleSync(arg?: unknown): Promise<void> {
    const item = arg instanceof SubmoduleTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleSubmoduleUpdateRecursive(): Promise<void> {
  ...
  public async handleSubmoduleUpdateAll(): Promise<void> {
    const submodules = this.state.submodules;
    const dirtyCount = submodules.filter((s) => s.isDirty).length;
    if (dirtyCount > 0) {
      const confirmed = await confirmDangerousAction({
  ...
  public async handleSubmoduleUpdate(arg?: unknown): Promise<void> {
    const item = arg instanceof SubmoduleTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleSubmoduleInitAll(): Promise<void> {
    const count = this.state.submodules.length;
    try {
      await withSubmoduleProgress(
        this.logger,
  ...
  public async handleSubmoduleInit(arg?: unknown): Promise<void> {
    const item = arg instanceof SubmoduleTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleSubmoduleRefresh(): Promise<void> {
    await this.state.refreshSubmodules();
  }
  public async handleWorktreeOpenTerminal(arg?: unknown): Promise<void> {
  ...
  public async handleWorktreeRevealInFinder(arg?: unknown): Promise<void> {
    const item = arg instanceof WorktreeTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleWorktreePrune(): Promise<void> {
  ...
  public async handleWorktreePrunePreview(): Promise<void> {
    const prunable = await this.git.getPrunableWorktrees();
    if (prunable.length === 0) {
      void vscode.window.showInformationMessage('No prunable worktrees found.');
      return;
  ...
  public async handleWorktreeUnlock(arg?: unknown): Promise<void> {
    const item = arg instanceof WorktreeTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleWorktreeLock(arg?: unknown): Promise<void> {
    const item = arg instanceof WorktreeTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleWorktreeRemoveForce(arg?: unknown): Promise<void> {
    const item = arg instanceof WorktreeTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleWorktreeRemove(arg?: unknown): Promise<void> {
    const item = arg instanceof WorktreeTreeItem ? arg : undefined;
    if (!item) {
      return;
    }
  ...
  public async handleWorktreeAddDetached(): Promise<void> {
  ...
  public async handleWorktreeAddNewBranch(): Promise<void> {
  ...
  public async handleWorktreeAddFromBranch(): Promise<void> {
  ...
  public async handleWorktreeOpenInNewWindow(arg?: unknown): Promise<void> {
    const item = arg instanceof WorktreeTreeItem ? arg : undefined;
  ...
  public async handleWorktreeOpen(arg?: unknown): Promise<void> {
    const item = arg instanceof WorktreeTreeItem ? arg : undefined;
    const worktreePath = item?.worktree.worktreePath;
    if (!worktreePath) {
      return;
  ...
  public async handleWorktreeRefresh(): Promise<void> {
    await this.state.refreshWorktrees();
  }
  public async handleFileBlameOpen(): Promise<void> {
  ...
  public async handleCommitAmend(): Promise<void> {
  ...
  public async handleUnstageFile(): Promise<void> {
  ...
  public async handleStageFile(): Promise<void> {
    const changed = await this.git.getChangedFiles();
    const candidates = changed.filter(
  ...
  public async handleStagePatch(): Promise<void> {
    const changed = await this.git.getChangedFiles();
    if (changed.length === 0) {
  ...
  public async handleGitSshPullCustom(): Promise<void> {
    await this.sshPull('prompt');
  }
  public async handleGitSshPullBitbucket(): Promise<void> {
    await this.sshPull('bitbucket.org');
  }
  public async handleGitSshPullGitlab(): Promise<void> {
    await this.sshPull('gitlab.com');
  }
  public async handleGitSshPullGithub(): Promise<void> {
    await this.sshPull('github.com');
  }
  public async handleGitFetchPrune(): Promise<void> {
    await this.git.fetchPrune();
    await this.state.refreshAll();
    void vscode.window.showInformationMessage('Fetch --prune completed.');
  }
  public async handleGitPullWithPreview(): Promise<void> {
  ...
  public async handleGitPushWithPreview(): Promise<void> {
    const preview = await this.git.getOutgoingIncomingPreview();
    const confirmed = await confirmDangerousAction({
  ...
  public async handleOperationSkip(): Promise<void> {
    const state = await this.git.getOperationState();
    if (state.kind === 'rebase') {
  ...
  public async handleConflictAcceptBoth(arg?: unknown): Promise<void> {
    await this.handleConflictResolve(arg, 'both');
  }
  public async handleConflictAcceptTheirs(arg?: unknown): Promise<void> {
    await this.handleConflictResolve(arg, 'theirs');
  }
  public async handleConflictAcceptOurs(arg?: unknown): Promise<void> {
    await this.handleConflictResolve(arg, 'ours');
  }
  public async handleMergeFinalize(): Promise<void> {
    const conflicts = await this.git.getMergeConflicts();
    if (conflicts.length > 0) {
      void vscode.window.showWarningMessage(
  ...
  public async handleMergePrevious(): Promise<void> {
    await vscode.commands.executeCommand('merge-conflict.previous');
  }
  public async handleMergeNext(): Promise<void> {
    await vscode.commands.executeCommand('merge-conflict.next');
  }
  public async handleMergeOpenConflict(): Promise<void> {
    const conflicts = await this.git.getMergeConflicts();
    if (conflicts.length === 0) {
  ...
  public async handleCompareOpen(): Promise<void> {
    await this.openCompareWorkflow();
  }
  public async handleDiffOpen(): Promise<void> {
    await this.openDiffWorkflow();
  }
  public async handleGraphLoadMore(): Promise<void> {
    await this.state.loadMoreGraph();
  }
  public async handleGraphClearFilter(): Promise<void> {
    await GraphFilterView.clearCurrentFilters();
    await vscode.commands.executeCommand('setContext', GitCommand.GraphFilterActive, false);
  }
  public async handleGraphShowRepositoryAtRevision(arg?: unknown): Promise<void> {
  ...
  public async handleGraphCreatePatchForRange(arg?: unknown, selected?: unknown): Promise<void> {
  ...
  public async handleGraphCreatePatch(arg?: unknown): Promise<void> {
  ...
  public async handleGraphGoToChildCommit(arg?: unknown): Promise<void> {
  ...
  public async handleGraphGoToParentCommit(arg?: unknown): Promise<void> {
    const sha = this.toCommitSha(arg) ?? (await this.pickCommitSha('Pick commit'));
    if (!sha) {
      return;
    }
  ...
  public async handleGraphRebaseInteractiveFromHere(arg?: unknown): Promise<void> {
    const base =
  ...
  public async handleGraphCompareWithCurrent(arg?: unknown): Promise<void> {
    const sha =
  ...
  public async handleGraphRevert(arg?: unknown, selected?: unknown): Promise<void> {
    const selectedShas = this.toGraphCommitShas(arg, selected);
    if (selectedShas.length === 0) {
  ...
  public async handleGraphCherryPickRange(): Promise<void> {
  ...
  public async handleGraphCreateTagHere(arg?: unknown): Promise<void> {
  ...
  public async handleGraphCreateBranchHere(arg?: unknown): Promise<void> {
  ...
  public async handleGraphCheckoutCommit(arg?: unknown): Promise<void> {
  ...
  public async handleGraphOpenRepositoryFileAtRevision(arg?: unknown): Promise<void> {
  ...
  public async handleCompareWithRevisionSwapDirection(): Promise<void> {
    await this.editor.swapActiveCompareDirection();
  }
  public async handleWorkingTreeCompareOpenFileDiff(arg?: unknown): Promise<void> {
  ...
  public async handleGraphCopyCommitMessage(arg?: unknown, selected?: unknown): Promise<void> {
    const shas = this.toGraphCommitShas(arg, selected);
    if (shas.length === 0) {
      return;
    }
  ...
  public async handleGraphCopyCommitId(arg?: unknown, selected?: unknown): Promise<void> {
    const shas = this.toGraphCommitShas(arg, selected);
    if (shas.length === 0) {
      return;
    }
  ...
  public async handleGraphOpenCommitRangeDetails(arg?: unknown, selected?: unknown): Promise<void> {
    const selectedShas = this.toGraphCommitShas(arg, selected);
  ...
  public async handleGraphOpenDetails(arg?: unknown, selected?: unknown): Promise<void> {
    const selectedShas = this.toGraphCommitShas(arg, selected);
  ...
  public async handleStashPreviewPatch(arg?: unknown): Promise<void> {
    const item = this.asStashItem(arg);
  ...
  public async handleStashRename(arg?: unknown): Promise<void> {
    const item = this.asStashItem(arg);
  ...
  public async handleStashDrop(arg?: unknown): Promise<void> {
    const item = this.asStashItem(arg);
  ...
  public async handleStashPop(arg?: unknown): Promise<void> {
    await this.handleStashApplyPop(arg, true);
  }
  public async handleStashApply(arg?: unknown): Promise<void> {
    await this.handleStashApplyPop(arg, false);
  }
  public async handleStashUnshelve(arg?: unknown): Promise<void> {
    const item = this.asStashItem(arg);
  ...
  public async handleBranchCompareWithCurrent(arg?: unknown): Promise<void> {
  ...
  public async handleBranchRebaseOnto(arg?: unknown): Promise<void> {
    const onto =
  ...
  public async handleBranchMergeIntoCurrent(arg?: unknown): Promise<void> {
    const branch =
  ...
  public async handleBranchUntrack(arg?: unknown): Promise<void> {
    const branch =
  ...
  public async handleBranchTrack(arg?: unknown): Promise<void> {
    const local =
  ...
  public async handleBranchDelete(arg?: unknown): Promise<void> {
  ...
  public async handleBranchRename(arg?: unknown): Promise<void> {
  ...
  public async handleRemoteDelete(arg?: unknown): Promise<void> {
  ...
  public async handleRemoteAdd(): Promise<void> {
  ...
  public async handleTagCreateCurrent(): Promise<void> {
  ...
  public async handleTagCreatePatch(arg?: unknown): Promise<void> {
    const revision =
  ...
  public async handleTagCompareWithCurrent(arg?: unknown): Promise<void> {
    const revision =
  ...
  public async handleTagShowRepositoryAtRevision(arg?: unknown): Promise<void> {
  ...
  public async handleTagCopyRevisionNumber(arg?: unknown): Promise<void> {
  ...
  public async handleTagCheckout(arg?: unknown): Promise<void> {
    const tagRef =
  ...
  public async handleTagCheckoutNewBranch(arg?: unknown): Promise<void> {
    const baseRef =
  ...
  public async handleBranchCreate(): Promise<void> {
  ...
  public async handleTagOpenCommits(arg?: unknown): Promise<void> {
    const revision =
  ...
  public async handleBranchCheckout(arg?: unknown): Promise<void> {
  ...
  public async handleBranchSearchRefresh(): Promise<void> {
    await BranchSearchView.refreshCurrent();
  }
  public async handleBranchOpenCommits(arg?: unknown): Promise<void> {
    const branchName =
  ...
  public async handleBranchActionHub(arg?: unknown): Promise<void> {
    await this.openBranchActionHub(arg);
  }
  public async handleQuickActions(): Promise<void> {
    await this.openQuickActions();
  }
  public async handleCommitViewClose(): Promise<void> {
    await this.commitFilesView.clear();
  }
